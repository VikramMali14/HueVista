...
class ClientIpsTest {
    ...
    void prefersFirstXForwardedForHop() {
        ...
        assertThat(ClientIps.clientIp(req, true)).isEqualTo("203.0.113.7");
    }
    ...
    void fallsBackToXRealIpWhenNoForwardedFor() {
        ...
        req.setRemoteAddr("10.0.0.99");
        assertThat(ClientIps.clientIp(req, true)).isEqualTo("198.51.100.5");
    }
    ...
    void fallsBackToRemoteAddrWhenNoHeaders() {
        ...
        assertThat(ClientIps.clientIp(req, true)).isEqualTo("192.0.2.44");
    }
    ...
    void ignoresForwardedHeadersWhenNotTrusted() {
        ...
        req.addHeader("X-Real-IP", "198.51.100.5");
        req.setRemoteAddr("192.0.2.44");
        assertThat(ClientIps.clientIp(req, false)).isEqualTo("192.0.2.44");
    }
}
