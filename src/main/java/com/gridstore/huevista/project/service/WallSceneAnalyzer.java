...
public class WallSceneAnalyzer {
    ...
    private String buildClassifyPrompt(ImageType imageType, int maskCount) {
        ...
        return ("You are looking at an %s photograph with %d numbered candidate masks overlaid on it.\n"
                ...
                + "- EXCLUDE: do NOT include mask numbers covering sky, clouds, trees, ground, dirt,\n"
                + "  road, sidewalk, vehicles, glass panes, AC units, electrical fixtures, stone\n"
                + "  cladding, exposed brick, ceramic tile, marble, wallpaper, wood paneling,\n"
                + "  furniture, decor, or background objects.\n"
