...
public class ImageCleanerService {
    ...
    private static final String CLEAN_PROMPT_INTERIOR =
          ...
          + "paint it, per FINISH.\n"
          + "- WALL TILE: a WALL. Resurface it so no tile grid and no grout line shows "
          + "through anywhere, then paint it white with the rest, carrying the white "
          ...
          + "even, evenly spaced lines cut into it. A note about THIS room, below, "
          + "overrides any of these — a bathroom's tile stays.\n\n"
          ...
          + "repainted per REPAINT. If you are unsure whether something counts as "
