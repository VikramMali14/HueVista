...
public class ImageCleanerService {
    ...
    private static final String CLEAN_PROMPT_INTERIOR =
          ...
          + "light fittings, no appliances, no new windows or doors, no shelves, mouldings,"
          + " panelling, wainscoting, feature walls, textures or patterns.\n"
          ...
          + "filled chases still showing. Carry it through the rest of the sequence — apply"
          + " the putty coat if it does not have one, then paint it a full opaque white so "
          + "no grey, sandy or chalky tone shows through anywhere.\n"
          ...
          + " across the whole plane — no roller texture, no lap marks, no brush strokes, "
          + "no patchiness, no tonal blotches, no visible joint between one plastered area "
          + "and the next. Walls that ALREADY look finished must come back at this same "
          + "flawless standard, never degraded or made patchier than they were.\n"
          ...
          + "Keep the ceiling's exact height and slope, and finish its beams the same way.\n"
          ...
          + " is false:\n"
          + "- No brick course, block edge or mortar joint is visible on ANY wall: every "
          + "wall is dead flat and smooth, not whitewashed brick.\n"
          ...
          + "- The ceiling is one smooth, flawless matte white plane at its original height"
          + " and slope, with no grey concrete and no plank lines, seamless with the walls.\n"
          + "- Walls and ceiling share ONE flawless matte white finish: even sheen, no "
          + "roller texture, no lap marks, no patchiness on either.\n"
          ...
          + " never left as bare plaster or bare putty — and the painted surfaces "
          + "repainted: walls, ceiling and trim one clean white, door leaves dark wood "
          + "brown, railings charcoal grey. If you are unsure whether something counts as "
          + "CLUTTER, leave it as it is: adding, staging or restyling is a failure, and an "
