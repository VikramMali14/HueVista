 ...
 *       unlimited on every tier. 0 = auto-masking not included (Starter:
 *       manual masking only).</li>
 * </ul>
 *
...
public enum Plan {
    ...
    STARTER(99900, 25, 0, 4, 25, "Starter"),
    ...
    /** GST charged on every plan and on pay-per-image overage. */
